...
OBJECTS	= $(BUILDER_OBJECTS) $(CLIENT_OBJECTS) $(SERVER_OBJECTS)

all: $(TARGETS)

$(BUILDER_TARGET): $(BUILDER_OBJECTS) $(HEADERS)
		$(CC) $(LDFLAGS) $(BUILDER_OBJECTS) -o $@ -lpthread

$(CLIENT_TARGET): $(CLIENT_OBJECTS) $(HEADERS)
		$(CC) $(LDFLAGS) $(CLIENT_OBJECTS) -o $@ -lpthread

$(SERVER_TARGET): $(SERVER_OBJECTS) $(HEADERS)
		$(CC) $(LDFLAGS) $(SERVER_OBJECTS) -o $@ -lpthread
